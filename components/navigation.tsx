          ...
          <div className="hidden md:flex items-center space-x-8">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200 font-medium text-sm relative",
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
              {navigation.map((item) => (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "block px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors duration-200 font-medium",
                    pathname === item.href && "text-purple-600 dark:text-purple-400",
                  )}
